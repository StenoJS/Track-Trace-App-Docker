...
import { STATUS_KEYWORDS_RE } from "./parse.js";
...
// afzender een bekende koerier is, óf als het onderwerp al naar een
// verzendupdate ruikt (tier 2 in parse.js, voor overige vervoerders/shops).
// Dit voorkomt dat we voor élke mail in de inbox de body gaan downloaden.
function isLikelyShippingMail(fromAddr, subject) {
  return isCourierSender(fromAddr) || STATUS_KEYWORDS_RE.test(subject || "");
}
